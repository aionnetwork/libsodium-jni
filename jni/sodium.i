...
int crypto_box_curve25519xchacha20poly1305_seal_open(unsigned char *m,
                                                     ...
                                                     const unsigned char *sk);
/*
     Verifiable Random Functions (VRFs) APIs
...
int crypto_vrf_keypair(unsigned char *pk,
                       unsigned char *sk);
int crypto_vrf_keypair_from_seed(unsigned char *pk,
                                 unsigned char *sk,
				 const unsigned char *seed);
...
int crypto_vrf_verify(unsigned char *output,
		      ...
		      const unsigned char *m,
                      unsigned long long mlen);
int crypto_vrf_proof_to_hash(unsigned char *hash,
                             const unsigned char *proof);
